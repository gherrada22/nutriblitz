...
const Benefits: React.FC = () => {
  const benefits: BenefitItem[] = [
    {
      icon: <Zap size={24} />,
      title: 'Energía Mejorada',
      description: 'Ingredientes naturales que proporcionan energía sostenida durante todo el día sin bajones.',
      color: 'yellow-400'
    },
    {
      icon: <BarChart size={24} />,
      title: 'Mejor Rendimiento',
      description: 'Mezcla optimizada de proteínas y carbohidratos para mejorar el rendimiento atlético.',
      color: 'green-500'
    },
    {
      icon: <Heart size={24} />,
      title: 'Salud Cardíaca e Inmune',
      description: 'Rico en antioxidantes que apoyan la salud cardiovascular y del sistema inmunológico.',
      color: 'green-600'
    },
    {
      icon: <Clock size={24} />,
      title: 'Rápido y Conveniente',
      description: 'Listo en menos de 60 segundos - perfecto para mañanas ocupadas y nutrición en movimiento.',
      color: 'brown-400'
    }
  ];
    ...
    <section id="benefits" className="py-20 bg-gradient-to-br from-brown-50 to-green-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center mb-12">
          <span className="text-green-600 font-medium">POR QUÉ ELEGIRNOS</span>
          <h2 className="text-3xl md:text-4xl font-bold text-brown-800 text-center mt-2">
            Beneficios que Transforman tu Día
          </h2>
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="grid md:grid-cols-2">
            <div className="p-8 lg:p-12 flex flex-col justify-center">
              <span className="text-green-600 font-medium">COMPROMISO DE CALIDAD</span>
              <h3 className="text-2xl md:text-3xl font-bold text-brown-800 mt-2 mb-4">
                No Comprometemos la Calidad de los Ingredientes
              </h3>
              <p className="text-brown-600 mb-6">
                En NutriBlitz, creemos que lo que entra en tu cuerpo es importante. Por eso utilizamos solo ingredientes orgánicos de la más alta calidad, libres de pesticidas, OGM, sabores artificiales y conservantes.
              </p>
              <ul className="space-y-3">
                {[
                  'Ingredientes orgánicos premium de granjas sostenibles',
                  'Pruebas rigurosas de calidad y pureza',
                  'Sin aditivos artificiales ni rellenos',
                  'Origen y fabricación transparentes',
                ].map((item, i) => (
            ...
            <div className="bg-green-100 relative hidden md:block">
              ...
              <div className="absolute bottom-8 left-8 bg-white rounded-lg shadow-lg p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-green-600 font-bold">4.9/5 Estrellas</p>
                    <p className="text-brown-700 text-sm">Calificación de Clientes</p>
                  </div>
                </div>
              </div>
            </div>
